...
int setupCircle(GLuint no_of_points, float radius);

const GLuint WIDTH = 800;
const GLuint HEIGHT = 600;

const GLuint NO_OF_POINTS = 5;

int main()
{
	glfwInit();

	GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "Exercicio 6.b", nullptr, nullptr);
	...
	GLuint VAO = setupCircle(NO_OF_POINTS, 0.5);
...
int setupCircle(GLuint no_of_points, float radius)
{
	...
	float angle = 0.0;
	float slice = 2 * M_PI / static_cast<float>(no_of_points);
