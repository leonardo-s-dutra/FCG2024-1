...
int setupPacman(float radius);

const GLuint WIDTH = 800;
const GLuint HEIGHT = 600;

const GLuint NO_OF_POINTS = 60;

int main()
{
	glfwInit();

	GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "Exercicio 6.c", nullptr, nullptr);
...
int setupPacman(float radius)
{
	...
	for(int i = 0; i < NO_OF_POINTS-4; i++) {
